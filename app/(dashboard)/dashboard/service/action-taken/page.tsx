...
export default async function ActionTakenPage() {
  const optionType: ServiceOptionType = "action_taken";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-surface-500 mt-1">
          Manage action taken options for recording service actions on job cards
        </p>
      </div>
      <ServiceOptionManager
        ...
        createLabel="Create Action Taken Option"
