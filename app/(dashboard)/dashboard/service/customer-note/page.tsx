...
export default async function CustomerNotePage() {
  const optionType: ServiceOptionType = "customer_note";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-surface-500 mt-1">
          Manage customer note templates for job card documentation
        </p>
      </div>
      <ServiceOptionManager
        ...
        createLabel="Create Customer Note"
