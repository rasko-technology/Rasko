...
export default async function DefaultIssuesPage() {
  const optionType: ServiceOptionType = "default_issue";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-surface-500 mt-1">
          Manage default issue options shown when creating job cards
        </p>
      </div>
      <ServiceOptionManager
        ...
        createLabel="Create New Issue Option"
