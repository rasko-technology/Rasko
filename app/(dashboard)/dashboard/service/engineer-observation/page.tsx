...
export default async function EngineerObservationPage() {
  const optionType: ServiceOptionType = "engineer_observation";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-surface-500 mt-1">
          Manage engineer observation templates for service reports
        </p>
      </div>
      <ServiceOptionManager
        ...
        createLabel="Create Observation Option"
