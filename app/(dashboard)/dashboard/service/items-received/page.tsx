...
export default async function ItemsReceivedPage() {
  const optionType: ServiceOptionType = "items_received";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-surface-500 mt-1">
          Manage item received options for tracking accessories received with
          devices
        </p>
      </div>
      <ServiceOptionManager
        ...
        createLabel="Create New Item Received"
