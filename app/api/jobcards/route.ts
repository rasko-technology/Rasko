...
export async function GET(request: NextRequest) {
  ...
  let query = supabase
    .from("jobcards")
    .select(
      "id, customer_name, phone, product_name, brand, model_name, status, priority, payment_type, incoming_source, estimation_amount, advance_amount, created_at, employees(name), customers(id, name, phone)",
    )
